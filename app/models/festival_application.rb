class FestivalApplication < ActiveRecord::Base
  ...
  attr_accessible :conductor, :contact_person, :equipment, :country_code, :num_players, :orch_name, :orchestra, :special_cast, :group_type,:permission,:festival_concert_id, :visitor_type, :rehearsal_time, :payment_status, :tickets, :tickets_red, :bdz_tickets_red, :bdz_tickets
