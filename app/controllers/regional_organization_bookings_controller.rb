class RegionalOrganizationBookingsController < AuthenticatedController
  ...
  def new
    ...
    @booking = RegionalOrganizationBooking.new(:regional_organization=>@regional_organization,:booking_date=>Time.now,:booking_year=>Time.now.year,:booking_mode=>'M',:booking_type=>'S')
