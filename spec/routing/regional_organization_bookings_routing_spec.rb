...
RSpec.describe RegionalOrganizationBookingsController, :type => :routing do
  describe "routing" do
    ...
    it "routes to #edit" do
      expect(:get => "/regional_organization_bookings/1/edit").to route_to("regional_organization_bookings#edit", :id => "1")
    end
    ...
    it "routes to #update via PUT" do
      expect(:put => "/regional_organization_bookings/1").to route_to("regional_organization_bookings#update", :id => "1")
    end

    it "routes to #destroy" do
      expect(:delete => "/regional_organization_bookings/1").to route_to("regional_organization_bookings#destroy", :id => "1")
    end
