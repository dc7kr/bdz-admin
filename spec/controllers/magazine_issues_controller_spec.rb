...
RSpec.describe MagazineIssuesController, type: :controller do
  ...
  describe 'GET #show' do
    it 'assigns the requested magazine_issue as @magazine_issue' do
      magazine_issue = MagazineIssue.create! valid_attributes
      get :show, params: { id: magazine_issue.to_param }
  ...
  describe 'GET #edit' do
    it 'assigns the requested magazine_issue as @magazine_issue' do
      magazine_issue = MagazineIssue.create! valid_attributes
      get :edit, params: { id: magazine_issue.to_param }
      expect(assigns(:magazine_issue)).to eq(magazine_issue)
    end
  end
  ...
  describe 'POST #create' do
    context 'with valid params' do
      it 'creates a new MagazineIssue' do
        expect do
          post :create, params: { magazine_issue: valid_attributes }
        end.to change(MagazineIssue, :count).by(1)
      end
    ...
    context 'with invalid params' do
      it 'assigns a newly created but unsaved magazine_issue as @magazine_issue' do
        post :create, params: { magazine_issue: invalid_attributes }
        expect(assigns(:magazine_issue)).to be_a_new(MagazineIssue)
      end
  ...
  describe 'PUT #update' do
    context 'with valid params' do
      ...
      it 'updates the requested magazine_issue' do
        magazine_issue = MagazineIssue.create! valid_attributes
        put :update, params: { id: magazine_issue.to_param, magazine_issue: new_attributes }
      ...
      it 'assigns the requested magazine_issue as @magazine_issue' do
        magazine_issue = MagazineIssue.create! valid_attributes
        put :update, params: { id: magazine_issue.to_param, magazine_issue: valid_attributes }
        expect(assigns(:magazine_issue)).to eq(magazine_issue)
      end
    ...
    context 'with invalid params' do
      it 'assigns the magazine_issue as @magazine_issue' do
        magazine_issue = MagazineIssue.create! valid_attributes
        put :update, params: { id: magazine_issue.to_param, magazine_issue: invalid_attributes }
        expect(assigns(:magazine_issue)).to eq(magazine_issue)
      end
  ...
  describe 'DELETE #destroy' do
    it 'destroys the requested magazine_issue' do
      magazine_issue = MagazineIssue.create! valid_attributes
      expect do
        delete :destroy, params: { id: magazine_issue.to_param }
      end.to change(MagazineIssue, :count).by(-1)
    end
