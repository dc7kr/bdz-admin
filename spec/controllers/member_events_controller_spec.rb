...
RSpec.describe MemberEventsController, type: :controller do
  ...
  # MemberEventsController. Be sure to keep this updated too.
  let(:valid_session) { {} }
  ...
  describe 'GET #show' do
    it 'assigns the requested member_event as @member_event' do
      member_event = MemberEvent.create! valid_attributes
      get :show, params: { id: member_event.to_param }
  ...
  describe 'GET #edit' do
    it 'assigns the requested member_event as @member_event' do
      member_event = MemberEvent.create! valid_attributes
      get :edit, params: { id: member_event.to_param }
      expect(assigns(:member_event)).to eq(member_event)
    end
  end
  ...
  describe 'POST #create' do
    context 'with valid params' do
      it 'creates a new MemberEvent' do
        expect do
          post :create, params: { member_event: valid_attributes }
        end.to change(MemberEvent, :count).by(1)
      end
    ...
    context 'with invalid params' do
      it 'assigns a newly created but unsaved member_event as @member_event' do
        post :create, params: { member_event: invalid_attributes }
        expect(assigns(:member_event)).to be_a_new(MemberEvent)
      end
  ...
  describe 'PUT #update' do
    context 'with valid params' do
      ...
      it 'updates the requested member_event' do
        member_event = MemberEvent.create! valid_attributes
        put :update, params: { id: member_event.to_param, member_event: new_attributes }
        member_event.reload
      ...
      it 'assigns the requested member_event as @member_event' do
        member_event = MemberEvent.create! valid_attributes
        put :update, params: { id: member_event.to_param, member_event: valid_attributes }
        expect(assigns(:member_event)).to eq(member_event)
      end
    ...
    context 'with invalid params' do
      it 'assigns the member_event as @member_event' do
        member_event = MemberEvent.create! valid_attributes
        put :update, params: { id: member_event.to_param, member_event: invalid_attributes }
        expect(assigns(:member_event)).to eq(member_event)
      end
  ...
  describe 'DELETE #destroy' do
    it 'destroys the requested member_event' do
      member_event = MemberEvent.create! valid_attributes
      expect do
        delete :destroy, params: { id: member_event.to_param }
      end.to change(MemberEvent, :count).by(-1)
    end
