...
RSpec.describe "orchestra_contacts/new", :type => :view do
  before(:each) do
    assign(:orchestra_contact, OrchestraContact.new(
      :orchestra_id => 1,
      :salutation => "MyString",
      :first_name => "MyString",
      :last_name => "MyString",
  ...
  it "renders new orchestra_contact form" do
    render

    assert_select "form[action=?][method=?]", orchestra_contacts_path, "post" do
