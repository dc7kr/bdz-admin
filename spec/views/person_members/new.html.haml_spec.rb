...
RSpec.describe "person_members/new", :type => :view do
  before(:each) do
    assign(:person_member, PersonMember.new(
      :mitgliedsnummer => 1,
      :anrede => "MyString",
      :vorname => "MyString",
      :nachname => "MyString",
  ...
  it "renders new person_member form" do
    render

    assert_select "form[action=?][method=?]", person_members_path, "post" do
