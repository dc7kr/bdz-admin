...
RSpec.describe "report_sheets/edit", :type => :view do
  before(:each) do
  ...
  it "renders the edit report_sheet form" do
    render

    assert_select "form[action=?][method=?]", report_sheet_path(@report_sheet), "post" do
