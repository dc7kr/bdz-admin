...
RSpec.describe 'member_account_bookings/edit', type: :view do
  before(:each) do
  ...
  it 'renders the edit member_account_booking form' do
    render

    assert_select 'form[action=?][method=?]', member_account_booking_path(@member_account_booking), 'post' do
