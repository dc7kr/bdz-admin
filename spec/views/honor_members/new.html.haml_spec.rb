...
RSpec.describe 'honor_members/new', type: :view do
  before(:each) do
    assign(:honor_member, HonorMember.new(
                            nr: 1,
                            vorname: 'MyString',
                            name: 'MyString',
                            ort: 'MyString',
  ...
  it 'renders new honor_member form' do
    render

    assert_select 'form[action=?][method=?]', honor_members_path, 'post' do
