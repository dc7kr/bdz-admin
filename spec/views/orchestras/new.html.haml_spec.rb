...
RSpec.describe "orchestras/new", :type => :view do
  before(:each) do
    assign(:orchestra, Orchestra.new(
      :mglnr => 1,
      :orchName => "MyString",
      :anrede => "MyString",
      :vorname => "MyString",
  ...
  it "renders new orchestra form" do
    render

    assert_select "form[action=?][method=?]", orchestras_path, "post" do
