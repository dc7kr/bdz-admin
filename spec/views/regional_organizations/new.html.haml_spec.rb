...
RSpec.describe "regional_organizations/new", :type => :view do
  before(:each) do
    assign(:regional_organization, RegionalOrganization.new(
      :nummer => 1,
      :name => "MyString",
      :subname => "MyString",
      :homepage => "MyString",
  ...
  it "renders new regional_organization form" do
    render

    assert_select "form[action=?][method=?]", regional_organizations_path, "post" do
