...
Rails.application.configure do
  ...
  config.action_cable.allowed_request_origins = [ "https://admin-dev.zupfmusiker.de" ]
  ...
  config.action_mailer.default_url_options = { host: "admin-dev.zupfmusiker.de" }
